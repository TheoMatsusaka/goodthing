...
public class MainActivity extends AppCompatActivity implements SalutDataCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        encryptedMessageText.setVisibility(View.GONE);
...
//                messageText.setText(inputMessage);
                ...
                publicKey = Serialize.Serialize(key.getPublic());
...
//        myMessage.message1 = "Encrypted Message: " + messageToSend + " \n"
//        + "Public key: ";
        myMessage.message1 = messageToSend;
